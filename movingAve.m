%Taken from http://www.mathworks.com/matlabcentral/fileexchange/8251-moving-averages---moving-median-etc/content/moving.m
%Written by Aslak Grinsted (http://www.mathworks.com/matlabcentral/profile/authors/870202-aslak-grinsted)
%June 16, 2011
%Note: Modified by Antony Lam. The added line is noted below.
function [y]=movingAve(x,m,fun)
m = round(m); %Added by Antony Lam to ensure m is an integer.
